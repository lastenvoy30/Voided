...
<div className="absolute top-8 left-16 text-white opacity-20 text-2xl rotate-45">◆</div>
<div className="absolute top-12 right-20 text-white opacity-20 text-xl rotate-12">◆</div>
<div className="absolute bottom-16 left-24 text-white opacity-10 text-lg rotate-45">◆</div>
<div className="absolute top-6 right-1/3 text-white opacity-10 text-sm">✦</div>
<div className="absolute bottom-10 right-1/4 text-white opacity-10 text-sm">✦</div>

<div className="absolute top-1/2 left-8 text-blue-400 opacity-15 text-3xl rotate-12">◆</div>
<div className="absolute top-4 left-1/3 text-white opacity-10 text-xs rotate-45">◆</div>
<div className="absolute bottom-4 left-1/3 text-blue-300 opacity-15 text-base rotate-6">◆</div>
<div className="absolute top-1/3 right-8 text-white opacity-10 text-2xl -rotate-12">◆</div>
<div className="absolute bottom-6 right-12 text-blue-400 opacity-15 text-lg rotate-45">◆</div>
<div className="absolute top-16 left-1/2 text-white opacity-10 text-xs">✦</div>
<div className="absolute bottom-12 left-12 text-white opacity-10 text-xs">✦</div>
<div className="absolute top-3 left-40 text-blue-300 opacity-10 text-sm rotate-45">◆</div>
<div className="absolute bottom-3 right-40 text-white opacity-10 text-sm -rotate-12">◆</div>
<div className="absolute top-1/2 right-1/3 text-blue-400 opacity-10 text-xs rotate-45">✦</div>
      ...
      <div className="relative z-10 flex items-center gap-4">
        <div className="flex items-center gap-2 bg-[#161A23] border border-[#1E2433] rounded-lg px-4 py-2">
